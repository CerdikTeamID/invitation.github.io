...
<head>
  ...
  <!-- Link -->
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('');?>style/img/logo-smkn6.png">
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-11 col-lg-11 col-md-10">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5" style="background-color: #ffff;">
          <div class="card-body p-3">
            <!-- Nested Row within Card Body -->
            <div class="row">
              <div class="p-3">
                  <div class="imgcontainer">
                    <img src="<?php echo base_url('');?>style/img/logo.png" alt="Avatar" class="avatar">
                  </div>
